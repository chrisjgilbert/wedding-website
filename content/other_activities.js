const content = [
  {
    title: "Cycling",
    content:
      "The area is full of cyclists, both casual and formal, and there are plenty of exceptional rides to be enjoyed. For those interested in hiring bikes, there are several in hire shops in Bonniuex including the Lucy and Jo Thomson favourite; Sun-E bike. Given the hills electric bikes aren't a bad idea, but for those of you in need of a physical challenge then why not take on the challenge of Mount Ventoux which is a little over an hours drive from Ménerbes.",
  ...
  },
  {
    ...
    content:
      "The Ochre Trail is a pathway through the ombre coloured cliffs of a former ochre mine - the colour is a result of iron oxide deposits dating back millions of years and is pretty spectacular. The Conservatoire des ocres et de la couleur is also popular stop.",
  ...
  },
  {
    ...
    content:
      "About a 45 min drive away, this is an amazing system of caves near Les Baumes, that feature multi media art installations,previous ones have included Cezanne, Kandinsky, and Monet but you will need to check their web site to see what their programme is for 2022. Worth arriving early to avoid the queues and to get a parking space",
